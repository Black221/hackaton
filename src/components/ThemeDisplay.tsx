...
export default function ThemeDisplay({ theme, icon, action }: ThemeDisplayProps) {
    ...
    return (<>
        <div onClick={action} className="w-32 h-32 p-4 m-4 bg-white border-2 border-1 border-green-2 rounded-lg flex flex-col items-center justify-center cursor-pointer">
